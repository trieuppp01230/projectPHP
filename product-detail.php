<?php
    ...
    $object = new Product();
    $productByID = $object->getProductById($id);
?>
    ...
    <main class="ps-main">
      ...
      <?php foreach($productByID as $proId) { ?>
            ...
            <div class="col-lg-10 col-md-12 col-lg-offset-1">
              <div class="ps-product__thumbnail">
                <div class="ps-product__preview">
                  <div class="ps-product__variants">
                    <div class="item"><img src="template/images/shoe-detail/1.jpg" alt=""></div>
                    <div class="item"><img src="template/images/shoe-detail/2.jpg" alt=""></div>
                    <div class="item"><img src="template/images/shoe-detail/3.jpg" alt=""></div>
                    <div class="item"><img src="template/images/shoe-detail/3.jpg" alt=""></div>
                    <div class="item"><img src="template/images/shoe-detail/3.jpg" alt=""></div>
                  </div><a class="popup-youtube ps-product__video" href="http://www.youtube.com/watch?v=0O2aH4XLbto"><img src="template/images/shoe-detail/1.jpg" alt=""><i class="fa fa-play"></i></a>
                </div>
                <div class="ps-product__image">
                  <div class="item"><img class="zoom" src="template/images/shoe-detail/1.jpg" alt="" data-zoom-image="template/images/shoe-detail/1.jpg"></div>
                  <div class="item"><img class="zoom" src="template/images/shoe-detail/2.jpg" alt="" data-zoom-image="template/images/shoe-detail/2.jpg"></div>
                  <div class="item"><img class="zoom" src="template/images/shoe-detail/3.jpg" alt="" data-zoom-image="template/images/shoe-detail/3.jpg"></div>
                </div>
              </div>
              <div class="ps-product__thumbnail--mobile">
                <div class="ps-product__main-img"><img src="template/images/" alt=""></div>
              ...
              <div class="ps-product__info">
                ...
                <div class="ps-product__block ps-product__style">
                  ...
                  <ul>
                    <li><a href="product-detail.php"><img src="template/images/shoe/sidebar/1.jpg" alt=""></a></li>
                    <li><a href="product-detail.php"><img src="template/images/shoe/sidebar/2.jpg" alt=""></a></li>
                    <li><a href="product-detail.php"><img src="template/images/shoe/sidebar/3.jpg" alt=""></a></li>
                    <li><a href="product-detail.php"><img src="template/images/shoe/sidebar/2.jpg" alt=""></a></li>
                  </ul>
                </div>
              ...
              <div class="tab-content mb-60">
                ...
                <div class="tab-pane" role="tabpanel" id="tab_02">
                  ...
                  <div class="ps-review">
                    <div class="ps-review__thumbnail"><img src="template/images/user/1.jpg" alt=""></div>
